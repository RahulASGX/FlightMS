...
public class Book2 extends HttpServlet { 
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException { 
		...
		String f_name[]=new String[nop];
		String l_name[]=new String[nop];
		int age[]=new int[nop];
		String sex[]=new String[nop];
		String contact[]=new String[nop];
		String email[]=new String[nop];
		String spcl_type[]=new String[nop];
		String seattypeone[]=new String[nop];
		String seattypetwo[]=new String[nop];
		String mealtype[]=new String[nop];
		String any_spcl_req[]=new String[nop];
		String payment_status[]=new String[nop];
		...
		for( int j=0; j<nop; j++) {
		   f_name[j]=(request.getParameter("f_name"+(j+1)));
		   l_name[j]=(request.getParameter("l_name"+(j+1)));
	       age[j]=Integer.parseInt(request.getParameter("age"+(j+1)));   
	       sex[j]=(request.getParameter("sex"+(j+1)));
           contact[j]=(request.getParameter("contact"+(j+1)));
	       spcl_type[j]=(request.getParameter("spcl_type"+(j+1)));
           email[j]=(request.getParameter("email"+(j+1)));
           seattypeone[j]=(request.getParameter("seattypeone"+(j+1)));
		   seattypetwo[j]=(request.getParameter("seattypetwo"+(j+1)));
		   mealtype[j]=(request.getParameter("mealtype"+(j+1)));
		   any_spcl_req[j]=(request.getParameter("special_requirement"+(j+1)));
		   payment_status[j]=(request.getParameter("payment_status"+(j+1)));
		
		/*
		 * if(nop.equals("1")) { j=1; f_name[j]=(request.getParameter("f_name1"));
		 * 
		 * j=1; l_name[j]=(request.getParameter("l_name1"));
		 * 
		 * j=1; age[j]=Integer.parseInt(request.getParameter("age1"));
		 * 
		 * j=1; sex[j]=(request.getParameter("sex1"));
		 * 
		 * j=1; contact[j]=(request.getParameter("contact1"));
		 * 
		 * j=1; spcl_type[j]=(request.getParameter("spcl_type1"));
		 * 
		 * j=1; email[j]=(request.getParameter("email1"));
		 * 
		 * j=1; seattypeone[j]=(request.getParameter("seattypeone1"));
		 * 
		 * j=1; seattypetwo[j]=(request.getParameter("seattypetwo1"));
		 * 
		 * j=1; mealtype[j]=(request.getParameter("mealtype1"));
		 * 
		 * j=1; any_spcl_req[j]=(request.getParameter("special_requirement1"));
		 * 
		 * j=1; payment_status[j]=(request.getParameter("payment_status1")); } else
		 * if(nop.equals("2")) { j=1; f_name[j]=(request.getParameter("f_name1"));
		 ...
		 * }
		 * 
		 * else if(nop.equals("3")) { j=1; f_name[j]=(request.getParameter("f_name1"));
		 * f_name[++j]=(request.getParameter("f_name2"));
		 ...
		 * 
		 * } else { j=1; f_name[j]=(request.getParameter("f_name1"));
		 * f_name[++j]=(request.getParameter("f_name2"));
		 * f_name[++j]=(request.getParameter("f_name3"));
		 * f_name[++j]=(request.getParameter("f_name4"));
